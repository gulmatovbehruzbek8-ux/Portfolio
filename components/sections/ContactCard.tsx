...
import { Mail, ExternalLink, Send, SendHorizontal } from "lucide-react";
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              <form className="space-y-4" action={`mailto:${personal.email}`} method="post" encType="text/plain">
                ...
                <button
                  type="submit"
                  className="w-full bg-primary text-white font-bold py-4 rounded-xl hover:bg-primary/90 transition-all flex items-center justify-center space-x-2 group"
                >
                ...
                <p className="text-[10px] text-center text-text-muted italic">
                  Note: This form opens your email client. Backend integration pending.
                </p>
              </form>
            </motion.div>
